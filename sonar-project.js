...
sonarqubeScanner(
  {
    ...
    options: {
      ...
      'sonar.exclusions':
        'src/assets/**, **/*.spec.ts, **/*.module.ts, *.env.ts, *.interceptor.ts, src/environments/**, src/app/core/utils/cif-validator.ts, src/app/services/item-example.service.ts, src/app/shared/utils.service.ts', // Entry point of your code which you want to exclude
