...
export class EjemploService extends ArqApiService {
  ...
  public getFilterMunicipios(filtro: string = '') {
    return this.getFilter(filtro, municipalitiesEsp);
  }

  public getFilterCountries(filtro: string = '') {
    return this.getFilter(filtro, countries);
  }

  public getFilter(filtro: string = '', data: ArqList[]) {
    let result = data;
    if (filtro) {
  ...
  public pruebaPeticionBack(){
    var _arqHttpClient: ArqHttpClient = new ArqHttpClient(this._http,environment);
