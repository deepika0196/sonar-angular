...
export class ItemExampleService {
  public urlApi = `${environment.settings.hostDynamic}/api/v1/item-example`;
  ...
  public getAll() {
    return this._arqHttpClient.get<ItemExample[]>(this.urlApi);
  }
  ...
  public insert(data: ItemExample) {
    return this._arqHttpClient.post<ItemExample>(this.urlApi, data);
  }
  ...
  public delete(id: number) {
    return this._arqHttpClient.delete<ItemExample>(`${this.urlApi}/${id}`);
  }
}
